...
var $author$project$Math$passage = _List_fromArray(
	[
...
var $author$project$Math$view = function (tex) {
...
var $author$project$Math$main = $author$project$Math$view($author$project$Math$passage);
_Platform_export({'Math':{'init':_VirtualDom_init($author$project$Math$main)(0)(0)}});}(this));